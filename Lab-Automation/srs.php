...
<head>
    ...
    <title>ELECTRONICA LAB | SRS DASHBOARD</title>
    <!-- Custom CSS -->
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <div class="row pb-2">
                                    <div class="col-sm-6 mb-4">
                                        ...
                                        <input type="text" id="fn" class="form-control form-control-lg" name="full_name"
                                            placeholder="Full Name" value="<?php echo $row['full_name']; ?>" require>
                                    ...
                                    <div class="col-12 mb-4">
                                        <label for="bio" class="form-label fs-base">Profile <small
                                                class="text-muted">(optional)</small></label>
                                        <input id="bio" type="file" accept="image/*" name="photo"
                                            class="form-control form-control-lg" placeholder="Add Your Profile"
                                            src="profile/<?php echo $row["photo"]; ?>">
                                    </div>
                                </div>
                                <?php
                            }
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                        ...
                                        <img src="<?php echo $row["photo"]; ?>" alt="profile" class="rounded-circle" width="40">
                                        <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                                class="text-dark"><?php echo $row["full_name"]; ?></span> <i
                        ...
                        ?>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <a type="button" data-toggle="modal" data-target="#exampleModalCenter"
                                    class="dropdown-item" href="javascript:void(0)"><i data-feather="user"
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="srs.php" aria-expanded="false">
                                <i data-feather="home" class="feather-icon">
                                </i>
                        ...
                        <div class="testing">
                        <li class="sidebar-item "> <a class="sidebar-link" href="srstest.php" aria-expanded="false"><i
                                    data-feather="tag" class="feather-icon"></i><span class="hide-menu">Testing
                                </span></a>
                        </li>
                        </div>
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="srs.php">Srs Dashboard</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">MANUFACTURING
                                        PRODUCTS
                                    </h6>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">PASSED PRODUCTS
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">FAILURE PRODUCTS
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">DEFAULT PRODUCTS
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                ...
                <form action="Productdetails.php" method="POST">
                    <div class="container-fluid py-3">
                        <h2 class="text-center bg-warning text-dark " style="text-transform: uppercase; border: radius 5px;">Recent Launch
                            Products</h2>
                        <div class="row mt-4">
                                        ...
                                        <div class="col-md-3 mt-3">
                                            <div class="card " style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <a href="#" class="btn btn-warning "><span>₨:</span>
                                                        <?php echo $row['p_price'] ?>
                                                    </a>
                                                    <a href="Productdetails.php?id=<?php echo $row['crip_id']; ?>" type="button"
                                                        class="btn btn-primary view-btn" data-bs-toggle="popover"
                                                        data-bs-target="#viewproduct">View Details</a>
            ...
            <footer class="footer text-center text-muted">
                All Rights Reserved by Lab Automation. Designed and Developed by <a
                    href="https://wrappixel.com/">2207F3</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
