...
<head>
    ...
    <title>ELECTRONICA LAB | CRIP DASHBOARD</title>
    <!-- Custom CSS -->
           ...
           ?>
               ...
               ?>
                            ...
                            <a  type="button" data-toggle="modal" data-target="#exampleModalCenter" class="dropdown-item" href="javascript:void(0)"><i data-feather="user"
                                ...
                                <a href="logout.php" class="dropdown-item  bg-danger" href="logout.php"><i data-feather="power"
                                        class="svg-icon mr-2 ml-1"></i>
                                    Logout</a>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="crip.php">Crip Dashboard</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
