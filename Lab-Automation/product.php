...
<html lang="en">
  <head>
    ...
    <title>ELECTRONICA LAB | PRODUCTS TABLE</title>
...
a.bg-danger:focus,a.bg-dan:hover,button.bg-danger:focus,button.bg-danger:hover {
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
           ...
           ?>
               ...
               ?>
                           <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <a  class="dropdown-item bg-dan" href="logout.php"><i data-feather="power"
                                        class="svg-icon mr-2 ml-1"></i>
                                    Logout</a>
                            </div>
                        </li>
     ...
     <!-- End Topbar header -->
      ...
      <!-- Button trigger modal -->
              ...
              <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#insertModalCenter">Add New Products</button>
      ...
      <input type="text" class="form-control" style="border-color: blue;" id="search" placeholder="Search" aria-label="Username" aria-describedby="basic-addon1">
                          </div>
