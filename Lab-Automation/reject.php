...
<head>
    ...
    <title>ELECTRONICA LAB | REJECTED ITEMS</title>
    <!-----bootstrap--->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">                       
                                    ...
                                    <li class="breadcrumb-item"><a href="reject.php">Reject</a> 
                                    </li>
                                </ol>
                            </nav>
                        </div>
          ...
          <?php
$sql = "SELECT * FROM srstbl INNER JOIN product on srstbl.product_id=product.product_id WHERE srs_result = 'fail'";
    ...
    while($row = mysqli_fetch_array($result)){
          ...
          <tbody>
            ...
            <td><?php echo '<img src = "upload/'.$row['p_img'].'" height="80px;" width="80px;" class="rounded-circle">'?> </td>
              ...
              <td class="text-center color"><?php echo $row['srs_result'];?></td>
            </tr>
          </tbody>
<?php
}
