...
<title>ELECTRONICA LAB | EMPLOYEE DETAILS</title>
    <!-----bootstrap--->
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="admin.php">Dashboard</a>                            
                                    ...
                                    <li class="breadcrumb-item"><a href="empdetails.php">Employees</a> 
                                    </li>
                                    </li>
                                </ol>
                            </nav>
            ...
            <div class="container-fluid">
                ...
                <!-- basic table -->
                <div class="row">
                <!-- <h1 class="text-center bg-danger text-white" style="text-transform:uppercase ;">Employees Department</h1> -->
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
...
if($result = mysqli_query($conn, $sql)){
  if(mysqli_num_rows($result) > 0){
    while($row = mysqli_fetch_array($result)){
     ...
     <input class="form-check-input" <?php if($row['status']=='connected'){echo "checked";}?> onclick="togglestatus(<?php echo $row['id']?>)" type="checkbox" role="switch" id="check">
  
        </div>
            </center>
              </td>
              <td><?php echo $row['role_type'];?></td>
              <td><img src="<?php echo $row["photo"]; ?>" alt="profile" class="rounded-circle"
                                    width="40"></td>
            </tr>
          </tbody>
<?php
